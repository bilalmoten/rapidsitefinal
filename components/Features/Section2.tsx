    ...
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        ...
        <p className="text-sm lg:text-base max-w-2xl my-4 mx-auto  text-center font-normal text-neutral-300">
          Explore examples of stunning websites created with our RapidSite AI
          Website Builder. Find inspiration and see how our templates can bring
          your vision to life.
        </p>
      </div>
...
const FeatureTitle: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => {
  return (
