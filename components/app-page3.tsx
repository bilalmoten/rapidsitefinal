...
function MovingBlob({ darkMode }: { darkMode: boolean }) {
  return (
    <motion.div
    ...
    <section className="container mx-auto px-4 py-20 md:py-32 flex flex-col md:flex-row items-center">
      <div className="md:w-1/2 mb-10 md:mb-0">
        ...
        >
          <Button
            size="lg"
            className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-3 rounded-full relative overflow-hidden"
          >
            Get Started
            <BorderBeam />
          </Button>
          <Button
            size="lg"
            variant="outline"
            className={`border-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 px-8 py-3 rounded-full relative overflow-hidden ${
...
function TestimonialsSection({ darkMode }: { darkMode: boolean }) {
  const testimonials = [
    {
      name: "John Doe",
      role: "Entrepreneur",
    ...
    <section className="py-20 relative overflow-hidden">
      <div
        className={`absolute inset-0 ${
          darkMode
            ? "bg-gradient-to-r from-indigo-900 to-purple-900 opacity-90"
            : "bg-gradient-to-r from-indigo-500 to-purple-600 opacity-90"
        }`}
      />
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <Button
          ...
          } hover:bg-opacity-90 px-8 py-3 rounded-full text-lg font-semibold relative overflow-hidden`}
        >
    ...
    <footer className={darkMode ? "bg-gray-800 py-12" : "bg-gray-100 py-12"}>
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <form className="flex">
              ...
              <Button
                type="submit"
                className="rounded-r-full bg-indigo-600 hover:bg-indigo-700 text-white relative overflow-hidden"
              >
                Subscribe
                <BorderBeam />
              </Button>
        ...
        <div
          ...
          } text-center ${darkMode ? "text-gray-300" : "text-gray-600"}`}
        >
          <p>
